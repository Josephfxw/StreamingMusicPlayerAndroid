...
public class MainActivity extends AppCompatActivity {
    ...
    static FloatingActionButton playNextButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playPauseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mServiceBound)
                    mBoundService.togglePlayer(); // get and bind function togglePlayer() from PlayerServer class.
            }
        });

        playPreviousButton = (FloatingActionButton) findViewById(R.id.PlayPreviousButton);
        ...
        playNextButton = (FloatingActionButton) findViewById(R.id.PlayNextButton);
    ...
    public void fetchSongsFromWeb () {
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    URL url = new URL("http://josephxwf.com/music_app/getmusic.php");
            ...
            public void run() {
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        startStreamingService(songAddress); //start playing
    ...
    public void markSongPlayed (final int id) {
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    URL url = new URL("http://josephxwf.com/music_app/add_play.php?id=" + Integer.toString(id));
                    urlConnection = (HttpURLConnection) url.openConnection();
                    urlConnection.setRequestMethod("GET");
    ...
    public void likeSong (final int id) {
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    URL url = new URL("http://josephxwf.com/music_app/add_like.php?id=" + Integer.toString(id));
                    urlConnection = (HttpURLConnection) url.openConnection();
                    urlConnection.setRequestMethod("GET");
